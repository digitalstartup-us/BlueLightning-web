...
const categories = ["All", "Custom Decks", "Pool Decks", "Patios", "Pergolas", "Full Outdoor", "Driveways", "Stamped Concrete"];
...
const projects = [
  ...
  { id: 13, title: "Louvered Pergola + Outdoor Kitchen",  location: "Northern Virginia",    category: "Full Outdoor",    desc: "Premium louvered pergola over a full outdoor kitchen station and porcelain patio — real Blue Lightning project.",               image: "/images/02 - Patios & Hardscaping/facebook_pergola-kitchen-porcelain-luxury_01.jpg",           material: "Aluminum · Porcelain · Steel",       cols: 2 },
  { id: 14, title: "Pool + Spa — Evening Porcelain",      location: "Northern Virginia",    category: "Pool Decks",      desc: "Pool and elevated spa with large-format porcelain deck, landscape bed steppers, and pergola structure in the background.",       image: "/images/05 - Pool Decks Full Outdoor Living/facebook_pool-porcelain-spa-evening_01.jpg",        material: "Porcelain · Travertine · LED",       cols: 1 },
  { id: 15, title: "Sunken Fire Pit Lounge — Pool",       location: "Northern Virginia",    category: "Pool Decks",      desc: "Sunken conversation pit with composite bench seating, LED strip lighting, and fire table — adjacent to pool and stepping path.", image: "/images/05 - Pool Decks Full Outdoor Living/facebook_pool-sunken-firepit-led-night_01.jpg",      material: "Composite · LED · Porcelain",        cols: 1 },
  { id: 16, title: "Multi-Level Deck + Patio Aerial",     location: "Northern Virginia",    category: "Custom Decks",    desc: "Aerial drone shot of a composite deck, covered screened porch, and porcelain patio — a full outdoor living system.",             image: "/images/01 - Custom Decks/facebook_deck-patio-screened-aerial_01.jpg",                         material: "Composite · Porcelain · Screened",   cols: 1 },
  { id: 17, title: "Stamped Compass Rose Patio — Night",  location: "Northern Virginia",    category: "Patios",          desc: "Illuminated stamped concrete patio with compass rose medallion, stone seat wall with fire pit, and landscape lighting.",        image: "/images/08 - Stamped Concrete/facebook_stamped-compass-rose-night_01.jpg",                     material: "Stamped Concrete · Stone Wall",      cols: 2 },
  { id: 18, title: "Outdoor Kitchen — Stone Island",      location: "Northern Virginia",    category: "Full Outdoor",    desc: "Stone-clad outdoor kitchen island with granite countertop, built-in grill, and pizza oven on an L-shaped paver patio.",         image: "/images/04 - Outdoor Kitchens/facebook_outdoor-kitchen-stone-island-patio_01.jpg",              material: "Stone · Granite · Paver Patio",      cols: 1 },
];

...
const projects = [
  { id: 1, title: "The Ashburn Estate", location: "Ashburn, VA", category: "Full Outdoor", desc: "6,200 sq ft multi-level deck, integrated patio, outdoor kitchen, and pergola system.", image: "https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=900&q=80&auto=format", value: "$485K", material: "TimberTech + Techo-Bloc", cols: 2 },
  { id: 2, title: "McLean Poolside", location: "McLean, VA", category: "Pool Decks", desc: "Wraparound pool deck in AZEK with perimeter LED lighting and anti-slip treatment.", image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=700&q=80&auto=format", value: "$220K", material: "AZEK PVC", cols: 1 },
  { id: 3, title: "Loudoun Farmhouse", location: "Loudoun County, VA", category: "Patios", desc: "Natural blue stone patio with fire pit, retaining wall, and integrated step system.", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&q=80&auto=format", value: "$175K", material: "Natural Stone", cols: 1 },
  { id: 4, title: "Reston Rooftop", location: "Reston, VA", category: "Custom Decks", desc: "Rooftop deck transformation with cable railings, composite decking, and custom stair system.", image: "https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=900&q=80&auto=format", value: "$310K", material: "Trex Transcend", cols: 2 },
  { id: 5, title: "Great Falls Pavilion", location: "Great Falls, VA", category: "Pergolas", desc: "Custom motorized louvered pergola with integrated LED, outdoor heaters, and full weather protection.", image: "https://images.unsplash.com/photo-1600607686527-6fb886090705?w=700&q=80&auto=format", value: "$195K", material: "Aluminum + Polycarbonate", cols: 1 },
  { id: 6, title: "Herndon Outdoor Kitchen", location: "Herndon, VA", category: "Full Outdoor", desc: "Complete outdoor kitchen with JBL audio, professional grill station, bar, and Jandy spa integration.", image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=700&q=80&auto=format", value: "$290K", material: "AZEK + Stone Veneer", cols: 1 },
  { id: 7, title: "Sterling Custom Deck", location: "Sterling, VA", category: "Custom Decks", desc: "Multi-level composite deck with glass railings, under-deck dry system, and built-in lighting.", image: "https://images.unsplash.com/photo-1560185127-6ed189bf02f4?w=900&q=80&auto=format", value: "$185K", material: "TimberTech", cols: 2 },
  { id: 8, title: "Fairfax Paver Patio", location: "Fairfax, VA", category: "Patios", desc: "12,000 sq ft Techo-Bloc paver installation with built-in fire pit and retaining wall system.", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=700&q=80&auto=format", value: "$240K", material: "Techo-Bloc", cols: 1 },
  { id: 9, title: "Arlington Pool Deck", location: "Arlington, VA", category: "Pool Decks", desc: "Contemporary pool surround with porcelain tile, built-in seating, and custom drain system.", image: "https://images.unsplash.com/photo-1601921004897-b7d582836990?w=700&q=80&auto=format", value: "$165K", material: "Outdoor Porcelain", cols: 1 },
];
